...
!function (a) {
    ...
    b.prototype.getSuffix = function (a, b) {
        ...
        a.each(this.entries, function (e, f) {
            ...
            if (g.addClass("jg-entry"), g.data("jg.loaded") !== !0 && "skipped" !== g.data("jg.loaded"))if (null !== d.settings.rel && g.attr("rel", d.settings.rel), null !== d.settings.target && g.attr("target", d.settings.target),
                null !== h) {
        ...
        var b = {};
        if ("string" ===
            a.type(this.settings.maxRowHeight))this.settings.maxRowHeight.match(/^[0-9]+%$/) ? (b.value = parseFloat(this.settings.maxRowHeight.match(/^([0-9])+%$/)[1]) / 100, b.percentage = !1) : (b.value = parseFloat(this.settings.maxRowHeight), b.percentage = !0); else {
...
!function (a, b) {
    function c(b) {
        var c = a.extend({}, F, b);
        t = a("body"), u = s(), v = u !== !1, v || (u = "transitionend.wallpaper");
        for (var e = a(this), f = 0, g = e.length; g > f; f++)d.apply(e.eq(f), [a.extend({}, c)]);
        return t.hasClass("wallpaper-inititalized") || (t.addClass("wallpaper-inititalized"), x.on("resize.wallpaper", c, l)), e
    }

    function d(b) {
        var c = a(this);
        if (!c.hasClass("wallpaper")) {
            a.extend(b, c.data("wallpaper-options")), c.addClass("wallpaper").append('<div class="wallpaper-container"></div>'), b.guid = "wallpaper-" + A++, b.youTubeGuid =
                0, b.$target = c, b.$container = b.$target.find(".wallpaper-container"), b.$target.data("wallpaper", b).on("resize.wallpaper", b, k);
            var d = b.source;
            b.source = null, e(d, b, !0), b.onReady.call()
        }
    }

    function e(a, c, d) {
        if (a !== c.source) {
            if (c.source = a, c.isYouTube = !1, "object" == typeof a && "string" == typeof a.video) {
                var e = a.video.match(/(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i);
                e && e.length >= 1 && (c.isYouTube = !0, c.videoId = e[1])
            }
            if (c.isYouTube)c.playing = !1, c.playerReady = !1, c.posterLoaded = !1, h(a, c, d); else if ("object" != typeof a || a.hasOwnProperty("fallback")) {
                if (c.responsiveSource)for (var i in c.responsiveSource)c.responsiveSource.hasOwnProperty(i) && c.responsiveSource[i].mq.removeListener(m);
                if (c.responsive = !1, c.responsiveSource = null, "object" == typeof a) {
                    ...
                    for (var l in a)if (a.hasOwnProperty(l)) {
                        ...
                        if (n) {
                            ...
                            o.addListener(m), k.push({mq: o, source: a[l]}), o.matches && (j = a[l])
                        }
                    }
                    c.responsive = !0, c.responsiveSource =
                        k, a = j
                }
                f(a, c, !1, d)
            } else g(a, c, d)
        } else c.$target.trigger("wallpaper.loaded"), c.onLoad.call(c.$target)
    }

    function f(b, c, d, e) {
        var f = a('<div class="wallpaper-media wallpaper-image' + (e !== !0 ? " animated" : "") + '"><img alt="" /></div>'), g = f.find("img"), h = b;
        g.one("load.wallpaper", function () {
            z && f.addClass("native").css({backgroundImage: "url('" + h + "')"}), f.on(u, function (b) {
                r(b), a(b.target).is(f) && (f.off(u), d || i(c))
            }), setTimeout(function () {
                f.css({opacity: 1}), c.responsive && e && i(c)
            }, 0), k({data: c}), (!d || e) && (c.$target.trigger("wallpaper.loaded"),
                c.onLoad.call(c.$target)), y = a(".wallpaper-responsive")
        }).attr("src", h), c.responsive && f.addClass("wallpaper-responsive"), c.$container.append(f), (g[0].complete || 4 === g[0].readyState) && g.trigger("load.wallpaper")
    }

    function g(b, c, d) {
        if (c.source.poster && (f(c.source.poster, c, !0, !0), d = !1), !E) {
            var e = '<div class="wallpaper-media wallpaper-video' + (d !== !0 ? " animated" : "") + '">';
            e += "<video", c.loop && (e += " loop"), c.mute && (e += " muted"), e += ">", c.source.webm && (e += '<source src="' + c.source.webm + '" type="video/webm" />'),
            c.source.mp4 && (e += '<source src="' + c.source.mp4 + '" type="video/mp4" />'), c.source.ogg && (e += '<source src="' + c.source.ogg + '" type="video/ogg" />'), e += "</video>", e += "</div>";
            var g = a(e), h = g.find("video");
            h.one("loadedmetadata.wallpaper", function (b) {
                g.on(u, function (b) {
                    r(b), a(b.target).is(g) && (g.off(u), i(c))
                }), setTimeout(function () {
                    g.css({opacity: 1})
                }, 0), k({data: c}), c.$target.trigger("wallpaper.loaded"), c.onLoad.call(c.$target), c.hoverPlay ? c.$target.on("mouseover.boxer", G.play).on("mouseout.boxer", G.pause) :
                c.autoPlay && this.play()
    ...
    function h(c, d, e) {
        ...
        if (d.posterLoaded || (d.source.poster || (d.source.poster = "http://img.youtube.com/vi/" + d.videoId + "/0.jpg"), d.posterLoaded = !0, f(d.source.poster, d, !0, e), e = !1), !E)if (a("script[src*='youtube.com/iframe_api']").length || a("head").append('<script src="//www.youtube.com/iframe_api">\x3c/script>'), B) {
            var h = d.guid + "_" + d.youTubeGuid++, j = "";
            j += '<div class="wallpaper-media wallpaper-embed' + (e !== !0 ? " animated" : "") + '">', j += '<div id="' + h + '"></div>', j += "</div>";
            var l = a(j);
            d.$container.append(l), d.player && (d.oldPlayer = d.player, d.player = null), d.player = new b.YT.Player(h, {
                videoId: d.videoId,
                playerVars: {
                    controls: 0,
                    rel: 0,
                    ...
                    loop: d.loop ? 1 : 0,
                    autoplay: 1,
                    origin: b.location.protocol + "//" + b.location.host
                },
                events: {
                    onReady: function (a) {
                        d.playerReady = !0, d.mute && d.player.mute(), d.hoverPlay ? d.$target.on("mouseover.boxer",
                            G.play).on("mouseout.boxer", G.pause) : d.autoPlay && d.player.playVideo()
                    }, onStateChange: function (c) {
                        d.playing || c.data !== b.YT.PlayerState.PLAYING ? d.loop && d.playing && c.data === b.YT.PlayerState.ENDED && d.player.playVideo() : (d.playing = !0, (d.hoverPlay || !d.autoPlay) && d.player.pauseVideo(), d.$target.trigger("wallpaper.loaded"), d.onLoad.call(d.$target), l.on(u, function (b) {
                            r(b), a(b.target).is(l) && (l.off(u), i(d))
                        }), l.css({opacity: 1})), d.$target.find(".wallpaper-embed").addClass("ready")
        ...
        } else C.push({source: c, data: d})
    }

    function i(b) {
        var c = b.$container.find(".wallpaper-media");
        c.length >= 1 && (c.not(":last").remove(), b.oldPlayer = null), y = a(".wallpaper-responsive")
    }

    function j(b) {
        var c = b.$container.find(".wallpaper-media");
        c.length >= 1 && c.on(u, function (d) {
            r(d), a(d.target).is(c) && (a(this).remove(), delete b.source)
        }).css({opacity: 0})
    }

    function k(a) {
        r(a);
        for (var b = a.data, c = b.$container.find(".wallpaper-media"),
                 d = 0, e = c.length; e > d; d++) {
            var f = c.eq(d), g = b.isYouTube ? "iframe" : f.find("video").length ? "video" : "img", h = f.find(g);
            if (h.length && ("img" !== g || !b.nativeSupport)) {
                var i = b.$target.outerWidth(), j = b.$target.outerHeight(), k = q(b, h);
                b.width = k.naturalWidth, b.height = k.naturalHeight, b.left = 0, b.top = 0;
                var l = b.isYouTube ? b.embedRatio : b.width / b.height;
                b.height = j, b.width = b.height * l, b.width < i && (b.width = i, b.height = b.width / l), b.left = -(b.width - i) / 2, b.top = -(b.height - j) / 2, f.css({
                    height: b.height,
                    width: b.width,
                    left: b.left,
                    top: b.top
    ...
    function n() {
        p(w), y.each(function () {
            for (var b = a(this), c = (b.find("img"), b.parents(".wallpaper").data("wallpaper")), d = c.responsiveSource, e = 0, g = 0, h = d.length; h > g; g++)if (d.hasOwnProperty(g)) {
                var i = d[g].mq;
                i && i.matches && (e = g)
            }
            f(d[e].source, c, !1, !0), b.trigger("change.wallpaper")
        })
    }

    function o(a, b, c, d) {
        return p(a, d), setTimeout(c, b)
    }
    ...
    function q(a,
               b) {
        if (a.isYouTube)return {naturalHeight: 500, naturalWidth: 500 / a.embedRatio};
        if (b.is("img")) {
            var c = b[0];
            if ("undefined" != typeof c.naturalHeight)return {
                naturalHeight: c.naturalHeight,
                naturalWidth: c.naturalWidth
            };
            var d = new Image;
            return d.src = c.src, {naturalHeight: d.height, naturalWidth: d.width}
        }
        return {naturalHeight: b[0].videoHeight, naturalWidth: b[0].videoWidth}
    }
    ...
    function s() {
        ...
        for (var c in a)if (a.hasOwnProperty(c) && c in b.style)return a[c] + ".wallpaper";
        return !1
    }

    var t, u, v, w, x = a(b), y = null, z = "backgroundSize"in document.documentElement.style, A = 0, B = !1, C = [], D = b.navigator.userAgent || b.navigator.vendor || b.opera, E = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(D), F = (D.toLowerCase().indexOf("safari") >= 0 && D.toLowerCase().indexOf("chrome") < 0, {
        autoPlay: !0, embedRatio: 1.777777, hoverPlay: !1, loop: !0,
        mute: !0, onLoad: a.noop, onReady: a.noop, source: null
    }), G = {
        defaults: function (b) {
            return F = a.extend(F, b || {}), "object" == typeof this ? a(this) : !0
        }, destroy: function () {
            var b = a(this).each(function () {
                var b = a(this).data("wallpaper");
                b && (b.$container.remove(), b.$target.removeClass("wallpaper").off(".boxer").data("wallpaper", null))
            });
            return "undefined" != typeof t && "undefined" != typeof x && a(".wallpaper").length < 1 && (t.removeClass("wallpaper-inititalized"), x.off(".wallpaper")), b
        }, load: function (b) {
            return a(this).each(function () {
                var c =
                    a(this).data("wallpaper");
                c && e(b, c)
            })
        }, pause: function () {
            return a(this).each(function () {
                var b = a(this).data("wallpaper");
                if (b)if (b.isYouTube && b.playerReady)b.player.pauseVideo(); else {
            ...
            return a(this).each(function () {
                var b = a(this).data("wallpaper");
                if (b)if (b.isYouTube && b.playerReady)b.player.playVideo(); else {
                    var c = b.$container.find("video");
                    c.length && c[0].play()
                }
            })
    ...
    b.onYouTubeIframeAPIReady = function () {
        B = !0;
        for (var a in C)C.hasOwnProperty(a) && h(C[a].source, C[a].data);
        C = []
...
!function (a) {
    function b(b, d, e) {
        ...
        function g(b, c) {
            var d = [];
            if (c)for (var e = b; e > 0; e--)d.push(a("body").find('img[src="' + j.settings.preloadTheseImages[e - 1] + '"]')); else for (var f = b; f > 0; f--)j.frames.eq(j.settings.preloadTheseFrames[f - 1] - 1).find("img").each(function () {
                d.push(a(this)[0])
            });
            return d
        }
        ...
        function h(b, c) {
            ...
            var f = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==", g = b, h = a.isFunction(a.Deferred) ? a.Deferred() : 0, i = a.isFunction(h.notify), j = g.find("img").add(g.filter("img")), k = [], l = [], m = [];
            a.isPlainObject(c) && a.each(c, function (a, b) {
                "callback" === a ? c = b : h && h[a](b)
            }), j.length ?
                j.bind("load.imagesLoaded error.imagesLoaded", function (a) {
                    e(a.target, "error" === a.type)
                }).each(function (b, c) {
                    var d = c.src, g = a.data(c, "imagesLoaded");
        ...
        function i() {
            ...
            function c() {
                j.canvas.on("touchmove.sequence",
                    d), g = null, i = !1
            }

            function d(a) {
                if (j.settings.swipePreventsDefault && a.preventDefault(), i) {
                    var b = a.originalEvent.touches[0].pageX, d = a.originalEvent.touches[0].pageY, e = g - b, f = h - d;
            ...
            function e(a) {
                1 === a.originalEvent.touches.length && (g = a.originalEvent.touches[0].pageX,
                    h = a.originalEvent.touches[0].pageY, i = !0, j.canvas.on("touchmove.sequence", d))
            }

            if (a(j.settings.preloader).remove(), j.nextButton = j._renderUiElements(j.settings.nextButton, ".sequence-next"), j.prevButton = j._renderUiElements(j.settings.prevButton, ".sequence-prev"), j.pauseButton = j._renderUiElements(j.settings.pauseButton, ".sequence-pause"), j.pagination = j._renderUiElements(j.settings.pagination, ".sequence-pagination"), void 0 !== j.nextButton && j.nextButton !== !1 && j.settings.showNextButtonOnInit === !0 && j.nextButton.show(),
                void 0 !== j.prevButton && j.prevButton !== !1 && j.settings.showPrevButtonOnInit === !0 && j.prevButton.show(), void 0 !== j.pauseButton && j.pauseButton !== !1 && j.settings.showPauseButtonOnInit === !0 && j.pauseButton.show(), j.settings.pauseIcon !== !1 ? (j.pauseIcon = j._renderUiElements(j.settings.pauseIcon, ".sequence-pause-icon"), void 0 !== j.pauseIcon && j.pauseIcon.hide()) : j.pauseIcon = void 0, void 0 !== j.pagination && j.pagination !== !1 && (j.paginationLinks = j.pagination.children(), j.paginationLinks.on("click.sequence", function () {
                    var b =
                        a(this).index() + 1;
                    j.goTo(b)
                ...
                }), j.currentHashTag = location.hash.replace("#", ""), void 0 === j.currentHashTag || "" === j.currentHashTag ? j.nextFrameID = j.settings.startingFrameID : (j.frameHashIndex = a.inArray(j.currentHashTag, j.frameHashID), j.nextFrameID = -1 !== j.frameHashIndex ? j.frameHashIndex + 1 : j.settings.startingFrameID)),
                    j.nextFrame = j.frames.eq(j.nextFrameID - 1), j.nextFrameChildren = j.nextFrame.children(), void 0 !== j.pagination && a(j.paginationLinks[j.settings.startingFrameID - 1]).addClass("current"), j.transitionsSupported ? j.settings.animateStartingFrameIn ? j.settings.reverseAnimationsWhenNavigatingBackwards && j.settings.autoPlayDirection - 1 && j.settings.animateStartingFrameIn ? (j._resetElements(j.transitionPrefix, j.nextFrameChildren, "0s"), j.nextFrame.addClass("animate-out"), j.goTo(j.nextFrameID, -1, !0)) : j.goTo(j.nextFrameID,
                    1, !0) : (j.currentFrameID = j.nextFrameID, j.settings.moveActiveFrameToTop && j.nextFrame.css("z-index", j.numberOfFrames), j._resetElements(j.transitionPrefix, j.nextFrameChildren, "0s"), j.nextFrame.addClass("animate-in"), j.settings.hashTags && j.settings.hashChangesOnFirstFrame && (j.currentHashTag = j.nextFrame.prop(j.getHashTagFrom), document.location.hash = "#" + j.currentHashTag), setTimeout(function () {
                    j._resetElements(j.transitionPrefix, j.nextFrameChildren, "")
                }, 100), j._resetAutoPlay(!0, j.settings.autoPlayDelay)) :
                    (j.container.addClass("sequence-fallback"), j.currentFrameID = j.nextFrameID, j.settings.hashTags && j.settings.hashChangesOnFirstFrame && (j.currentHashTag = j.nextFrame.prop(j.getHashTagFrom), document.location.hash = "#" + j.currentHashTag), j.frames.addClass("animate-in"), j.frames.not(":eq(" + (j.nextFrameID - 1) + ")").css({
                        display: "none",
                        opacity: 0
                    }), j._resetAutoPlay(!0, j.settings.autoPlayDelay)), void 0 !== j.nextButton && j.nextButton.bind("click.sequence", function () {
                    j.next()
                }), void 0 !== j.prevButton && j.prevButton.bind("click.sequence",
                    function () {
                        j.prev()
        ...
        j.transitionPrefix = k[ModernizrForSequence.prefixed("transition")], j.animationPrefix = k[ModernizrForSequence.prefixed("animation")], j.transitionProperties = {}, j.transitionEnd = l[ModernizrForSequence.prefixed("transition")] +
            " " + l[ModernizrForSequence.prefixed("animation")], j.numberOfFrames = j.frames.length, j.transitionsSupported = void 0 !== j.transitionPrefix ? !0 : !1, j.hasTouch = "ontouchstart"in window ? !0 : !1, j.isPaused = !1, j.isBeingHoveredOver = !1, j.container.removeClass("sequence-destroyed"), j.paused = function () {
        }, j.unpaused = function () {
        }, j.beforeNextFrameAnimatesIn = function () {
        }, j.afterNextFrameAnimatesIn = function () {
        }, j.beforeCurrentFrameAnimatesOut = function () {
        }, j.afterCurrentFrameAnimatesOut = function () {
        }, j.afterLoaded = function () {
        },
            j.destroyed = function () {
            }, j.settings = a.extend({}, e, d), j.settings.preloader = j._renderUiElements(j.settings.preloader, ".sequence-preloader"), j.isStartingFrame = j.settings.animateStartingFrameIn ? !0 : !1, j.settings.unpauseDelay = null === j.settings.unpauseDelay ? j.settings.autoPlayDelay : j.settings.unpauseDelay, j.getHashTagFrom = j.settings.hashDataAttribute ? "data-sequence-hashtag" : "id", j.frameHashID = [], j.direction = j.settings.autoPlayDirection, j.settings.hideFramesUntilPreloaded && void 0 !== j.settings.preloader &&
        j.settings.preloader !== !1 && j.frames.hide(), "-o-" === j.transitionPrefix && (j.transitionsSupported = j._operaTest()), j.frames.removeClass("animate-in");
        var m = j.settings.preloadTheseFrames.length, n = j.settings.preloadTheseImages.length;
    ...
    a(window).bind("load", function () {
        ...
        startAutoPlay: function (a) {
            ...
            var b = this;
            b.isSoftPaused ? b.unpause() : (void 0 !== b.pauseButton && (b.pauseButton.addClass("paused"), void 0 !==
            b.pauseIcon && b.pauseIcon.show()), b.paused(), b.isSoftPaused = !0, b.isHardPaused = a ? !0 : !1, b.isPaused = !0, b._resetAutoPlay())
        }, unpause: function (a) {
            var b = this;
            ...
            var a = this;
            id = a.currentFrameID !== a.numberOfFrames ? a.currentFrameID + 1 : 1, a.active === !1 ||
            void 0 === a.active ? a.goTo(id, 1) : a.goTo(id, 1, !0)
        }, prev: function () {
            var a = this;
            ...
            if (f.nextFrameID === f.currentFrameID || f.settings.navigationSkip && f.navigationSkipThresholdActive || !f.settings.navigationSkip &&
                f.active || !f.transitionsSupported && f.active || !f.settings.cycle && 1 === c && f.currentFrameID === f.numberOfFrames || !f.settings.cycle && -1 === c && 1 === f.currentFrameID || f.settings.preventReverseSkipping && f.direction !== c && f.active)return !1;
            if (f.settings.navigationSkip && f.active && (f.navigationSkipThresholdActive = !0, f.settings.fadeFrameWhenSkipped && f.nextFrame.stop().animate({opacity: 0}, f.settings.fadeFrameTime), clearTimeout(f.transitionThresholdTimer), setTimeout(function () {
                    f.navigationSkipThresholdActive = !1
                }, f.settings.navigationSkipThreshold)),
                !f.active || f.settings.navigationSkip) {
                if (f.active = !0, f._resetAutoPlay(), f.direction = void 0 === c ? f.nextFrameID > f.currentFrameID ? 1 : -1 : c, f.currentFrame = f.canvas.children(".animate-in"), f.nextFrame = f.frames.eq(f.nextFrameID - 1), f.currentFrameChildren = f.currentFrame.children(), f.nextFrameChildren = f.nextFrame.children(), void 0 !== f.pagination && (f.paginationLinks.removeClass("current"), a(f.paginationLinks[f.nextFrameID - 1]).addClass("current")), f.transitionsSupported)void 0 !== f.currentFrame.length ? (f.beforeCurrentFrameAnimatesOut(),
                f.settings.moveActiveFrameToTop && f.currentFrame.css("z-index", 1), f._resetElements(f.transitionPrefix, f.nextFrameChildren, "0s"), f.settings.reverseAnimationsWhenNavigatingBackwards && 1 !== f.direction ? f.settings.reverseAnimationsWhenNavigatingBackwards && -1 === f.direction && (f.nextFrame.addClass("animate-out"), f._reverseTransitionProperties()) : (f.nextFrame.removeClass("animate-out"), f._resetElements(f.transitionPrefix, f.currentFrameChildren, ""))) : f.isStartingFrame = !1, f.active = !0, f.currentFrame.unbind(f.transitionEnd),
                    f.nextFrame.unbind(f.transitionEnd), f.settings.fadeFrameWhenSkipped && f.settings.navigationSkip && f.nextFrame.css("opacity", 1), f.beforeNextFrameAnimatesIn(), f.settings.moveActiveFrameToTop && f.nextFrame.css("z-index", f.numberOfFrames), f.settings.reverseAnimationsWhenNavigatingBackwards && 1 !== f.direction ? f.settings.reverseAnimationsWhenNavigatingBackwards && -1 === f.direction && (setTimeout(function () {
                    f._resetElements(f.transitionPrefix, f.currentFrameChildren, ""), f._resetElements(f.transitionPrefix, f.nextFrameChildren,
                        ""), f._reverseTransitionProperties(), f._waitForAnimationsToComplete(f.nextFrame, f.nextFrameChildren, "in"), ("function () {}" !== f.afterCurrentFrameAnimatesOut || f.settings.transitionThreshold === !0 && d !== !0) && f._waitForAnimationsToComplete(f.currentFrame, f.currentFrameChildren, "out", !0, -1)
                }, 50), setTimeout(function () {
                    f.settings.transitionThreshold === !1 || 0 === f.settings.transitionThreshold || d === !0 ? (f.currentFrame.removeClass("animate-in"), f.nextFrame.toggleClass("animate-out animate-in")) : (f.currentFrame.removeClass("animate-in"),
                    f.settings.transitionThreshold !== !0 && (f.transitionThresholdTimer = setTimeout(function () {
                ...
                }, 50)); else switch (f.settings.fallback.theme) {
                    case "fade":
                        f.frames.css({position: "relative"}), f.beforeCurrentFrameAnimatesOut(), f.currentFrame = f.frames.eq(f.currentFrameID - 1), f.currentFrame.animate({opacity: 0},
                            ...
                            }), f.frames.css({position: "relative"});
                        break;
                    case "slide":
                    default:
                        var h = {}, i = {}, j = {};
                        1 === f.direction ? (h.left = "-100%", i.left = "100%") : (h.left = "100%", i.left = "-100%"), j.left = "0", j.opacity = 1, f.currentFrame = f.frames.eq(f.currentFrameID -
                            1), f.beforeCurrentFrameAnimatesOut(), f.currentFrame.animate(h, f.settings.fallback.speed, function () {
        ...
        _initCustomKeyEvent: function (a) {
            ...
            var d = this;
            b.css(d._prefixCSS(a, {"transition-duration": c, "transition-delay": c, "transition-timing-function": ""}))
        }, _reverseTransitionProperties: function () {
            var b = this, c = [], d = [];
            b.currentFrameChildren.each(function () {
                c.push(parseFloat(a(this).css(b.transitionPrefix + "transition-duration").replace("s", "")) + parseFloat(a(this).css(b.transitionPrefix +
            ...
            var e = Math.max.apply(Math, c), f = Math.max.apply(Math, d), g = e - f, h = 0, i = 0;
            ...
            var j = function (c, d, e, f) {
                ...
                d.each(function () {
                    var d = parseFloat(a(this).css(b.transitionPrefix + "transition-duration").replace("s", "")), h = parseFloat(a(this).css(b.transitionPrefix + "transition-delay").replace("s", "")), i = a(this).css(b.transitionPrefix + "transition-timing-function");
                    if (-1 === i.indexOf("cubic"))var i =
                        g(i);
            ...
            c.data("animationEnded", !1), b.bind(g.transitionEnd,
                function (d) {
            ...
            window.ModernizrForSequence = function (a, b, c) {
                ...
                function i(a, b, c) {
                    var d =
                        a.charAt(0).toUpperCase() + a.slice(1), f = (a + " " + t.join(d + " ") + d).split(" ");
                    return e(b, "string") || e(b, "undefined") ? g(f, b) : (f = (a + " " + u.join(d + " ") + d).split(" "), h(f, b, c))
                }

                var j, k, l, m = "2.6.1", n = {}, o = b.documentElement, p = "modernizrForSequence", q = b.createElement(p), r = q.style, s = ({}.toString, "Webkit Moz O ms"), t = s.split(" "), u = s.toLowerCase().split(" "), v = {svg: "http://www.w3.org/2000/svg"}, w = {}, x = [], y = x.slice, z = {}.hasOwnProperty;
                l = e(z, "undefined") || e(z.call, "undefined") ? function (a, b) {
                    return b in a && e(a.constructor.prototype[b],
                            "undefined")
                } : function (a, b) {
                    return z.call(a, b)
                ...
                for (var A in w)l(w,
                    A) && (k = A.toLowerCase(), n[k] = w[A](), x.push((n[k] ? "" : "no-") + k));
            ...
            a("head").append("<style>.sequence-preloader{height: 100%;position: absolute;width: 100%;z-index: 999999;}@" + d + "keyframes preload{0%{opacity: 1;}50%{opacity: 0;}100%{opacity: 1;}}.sequence-preloader .preloading .circle{fill: #ff9442;display: inline-block;height: 12px;position: relative;top: -50%;width: 12px;" +
                d + "animation: preload 1s infinite; animation: preload 1s infinite;}.preloading{display:block;height: 12px;margin: 0 auto;top: 50%;margin-top:-6px;position: relative;width: 48px;}.sequence-preloader .preloading .circle:nth-child(2){" + d + "animation-delay: .15s; animation-delay: .15s;}.sequence-preloader .preloading .circle:nth-child(3){" + d + "animation-delay: .3s; animation-delay: .3s;}.preloading-complete{opacity: 0;visibility: hidden;" + d + "transition-duration: 1s; transition-duration: 1s;}div.inline{background-color: #ff9442; margin-right: 4px; float: left;}</style>"),
                b.prepend(e), ModernizrForSequence.svg || c ? c || setInterval(function () {
            ...
            return b.css("-o-transition",
                "1s"), "1s" !== b.css("-o-transition") ? (b.remove(), !1) : (b.remove(), !0)
        }
    };
    var d = {
        startingFrameID: 1,
...
(function ($, window, undefined) {
    ...
    $.DLMenu.prototype = {
        _init: function (options) {
            ...
            if (this.options.useActiveItemAsBackLabel)this.$back.each(function () {
                var $this =
                    $(this), parentLabel = $this.parents("li:first").find("a:first").text();
            ...
            this.$trigger.on("click.dlmenu", function () {
                if (self.open)self._closeMenu(); else {
                    self._openMenu();
            ...
            this.$back.on("click.dlmenu", function (event) {
                var $this = $(this), $submenu = $this.parents("ul.dl-submenu:first"), $item =
                    $submenu.parent(), $flyin = $submenu.clone().insertAfter(self.$menu);
    ...
    $.fn.dlmenu = function (options) {
        if (typeof options === "string") {
            ...
            var instance = $.data(this, "dlmenu");
            if (instance)instance._init(); else instance = $.data(this, "dlmenu", new $.DLMenu(options, this))
        });
        return this
    }
})(jQuery, window);
...
!function (l, o, e) {
    l.fn.scrollUp = function (o) {
        ...
        l("<div/>", {id: p.scrollName + "-active"}).css({
            position: "absolute",
        ...
        return this.each(function () {
            ...
            $.each(allImgs, function (i, img) {
                ...
                $(image).on("load." + eventNamespace +
                    " error." + eventNamespace, function (event) {
                    allImgsLoaded++;
...
!function (t) {
    function a(a, e) {
        var l, s, d, i = a.data("width"), c = a.data("height"), u = a.data("ratio") ? a.data("ratio") : e.default_ratio, o = a.data("youtube-id"), n = [], p = a.text() ? a.text() : e.loading_text, h = a.data("parameters") || "";
        u = u.split(":"), "number" == typeof i && "number" == typeof c ? (a.width(i), l = c + "px") : "number" == typeof i ? (a.width(i), l = i * u[1] / u[0] + "px") : (i = a.width(), 0 == i && (i = a.parent().width()), l = u[1] / u[0] * 100 + "%"), n.push('<div class="ytp-thumbnail">'), n.push('<div class="ytp-large-play-button"'), 640 >= i && n.push(' style="transform: scale(0.563888888888889);"'),
            ...
            a.css({"padding-bottom": l}).html(n.join("")), d = i > 640 ? "maxresdefault.jpg" : i > 480 ? "sddefault.jpg" : i > 320 ? "hqdefault.jpg" : i > 120 ? "mqdefault.jpg" : 0 == i ? "hqdefault.jpg" : "default.jpg", s = a.find(".ytp-thumbnail").css({"background-image": ["url(//img.youtube.com/vi/", o, "/", d, ")"].join("")}).addClass("lazyYT-image-loaded").on("click", function (t) {
...
window.Modernizr = function (a, b, c) {
    ...
    return e.addTest = function (a, b) {
        ...
        var c = a.html5 || {}, d = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, e = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,
    ...
    function i(a, c, d, e, f, i, j) {
        ...
        var j = j || B.errorTimeout,
            l = b.createElement(a), o = 0, r = 0, u = {t: d, s: c, e: f, a: i, x: j};
    ...
    var l = b.documentElement, m = a.setTimeout,
        n = b.getElementsByTagName("script")[0], o = {}.toString, p = [], q = 0, r = "MozAppearance"in l.style, s = r && !!b.createRange().compareNode, t = s ? l : n.parentNode, l = a.opera && "[object Opera]" == o.call(a.opera), l = !!b.attachEvent && !l, u = r ? "object" : l ? "script" : "img", v = l ? "script" : u, w = Array.isArray || function (a) {
    ...
    B = function (a) {
        function b(a) {
            var a = a.split("!"), b = x.length, c = a.pop(), d = a.length, c = {url: c, origUrl: c, prefixes: a},
                e, f, g;
    ...
    o.prototype = {
        ...
        showLightbox: function (t) {
            ...
            if (s.match(/\.(jpeg|jpg|gif|png)$/i) !== null) {
                ...
                if (a) {
                    var l = e("<iframe>", {
                        src: a, "class": f, frameborder: 0,
                        vspace: 0, hspace: 0, scrolling: "auto"
                    });
                    n.html(l);
                    l.load(function () {
            ...
            }); else if (s.substring(0, 1) == "#" && r.attr("data-lightbox-type") == "inline")if (e(s).length) {
                ...
                if (c.outerHeight() < n.height())c.css({
                    position: "relative", top: "50%", "margin-top": -(c.outerHeight() /
                    2) + "px"
                });
                e(t).resize(function () {
                    if (c.outerHeight() < n.height())c.css({
            ...
            if (a.options.clickOverlayToClose)t.on("click", function (t) {
                if (t.target === this || e(t.target).hasClass("nivo-lightbox-content") ||
                    e(t.target).hasClass("nivo-lightbox-image"))a.destructLightbox()
            });
...
(function (e) {
    ...
    var n = function (e, t) {
        ...
        if (!t.stepCount && !t.stepUnit)return window.console.error("Provide either stepCount or stepUnit value.");
    ...
    n.prototype = {
        constructor: n, fire: function (t) {
            ...
            if (!(this.options.from + this.options.to))this.current += this.options.stepUnit; else if (this.options.from < this.options.to)this.current += this.options.stepUnit; else if (this.options.from > this.options.to)this.current -= this.options.stepUnit;
            if (this.options.from < this.options.to) {
                if (this.current > this.options.to)return this.completed()
            } else if (this.options.from > this.options.to)if (this.current < this.options.to)return this.completed();
            this.fire("onStep");
            this.render()
        }, completed: function () {
    ...
    e.fn.numinate = function (r) {
        ...
        return this.each(function () {
            var t = e(this);
            if (i == "init")t.data("numinate", new n(t, r)); else t.data("numinate")[i]()
        })
    };
...
!function () {
    ...
    function o(e, t, o) {
        ...
        if (A.push({x: t, y: o, lastX: 0 > t ? .99 : -.99, lastY: 0 > o ? .99 : -.99, start: Date.now()}), !K) {
            var l = e === document.body, i = function () {
                for (var n = Date.now(), a = 0, r = 0, c = 0; c < A.length; c++) {
                    var u = A[c], d = n - u.start, s = d >= T.animationTime, f = s ? 1 : d / T.animationTime;
                    T.pulseAlgorithm && (f = y(f));
                    var m = u.x * f - u.lastX >> 0, h = u.y * f - u.lastY >> 0;
                    a += m, r += h, u.lastX += m, u.lastY += h, s && (A.splice(c, 1), c--)
                }
                l ? window.scrollBy(a, r) : (a && (e.scrollLeft += a), r && (e.scrollTop += r)), t || o || (A = []),
    ...
    function n(e) {
        ...
        return B && (e.wheelDeltaX && w(e.wheelDeltaX, 120) && (r = -120 * (e.wheelDeltaX / Math.abs(e.wheelDeltaX))), e.wheelDeltaY && w(e.wheelDeltaY, 120) && (i = -120 * (e.wheelDeltaY / Math.abs(e.wheelDeltaY)))), r || i || (i = -e.wheelDelta || 0), 1 === e.deltaMode &&
        (r *= 40, i *= 40), !T.touchpadSupport && p(i) ? !0 : (Math.abs(r) > 1.2 && (r *= T.stepSize / 120), Math.abs(i) > 1.2 && (i *= T.stepSize / 120), o(a, r, i), e.preventDefault(), void l())
    }
    ...
    function a(e) {
        ...
        if (a.test(t.nodeName) || m(t, "input") && !r.test(t.type) || m(S, "video") || b(e) || t.isContentEditable || e.defaultPrevented ||
            n)return !0;
    ...
    function p(e) {
        return e ? (Y.length || (Y = [e, e, e]), e = Math.abs(e), Y.push(e), Y.shift(), clearTimeout(k),
    ...
    function g(e) {
        var t, o, n;
        return e *= T.pulseScale, 1 > e ? t = e - (1 - Math.exp(-e)) : (o = Math.exp(-1), e -= 1, n =
            1 - Math.exp(-e), t = o + n * (1 - o)), t * T.pulseNormalize
    }
    ...
    "onwheel"in document.createElement("div") ? R = "wheel" : "onmousewheel"in document.createElement("div") && (R = "mousewheel"), R && (f(R, n), f("mousedown",
        r), f("load", t))
}();
!function () {
    function e(e) {
    ...
    var a, t = function (e, s) {
        ...
        function d(e) {
            ...
            if (v.params.mousewheelInvert && (t = -t), v.params.freeMode) {
                ...
                } else v.slideNext(); else if (v.isBeginning && !v.params.loop ||
                    v.animating) {
                    if (v.params.mousewheelReleaseOnEdges)return !0
                } else v.slidePrev();
        ...
        if (v.version = "3.1.0", v.params = s, v.classNames = [], "undefined" != typeof a && "undefined" != typeof Dom7 && (a = Dom7), ("undefined" != typeof a || (a = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (v.$ = a, v.container = a(e), 0 !== v.container.length)) {
            ...
            v.container[0].swiper = v, v.container.data("swiper", v), v.classNames.push("swiper-container-" + v.params.direction), v.params.freeMode && v.classNames.push("swiper-container-free-mode"), v.support.flexbox || (v.classNames.push("swiper-container-no-flexbox"), v.params.slidesPerColumn = 1), (v.params.parallax || v.params.watchSlidesVisibility) && (v.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(v.params.effect) >= 0 && (v.support.transforms3d ? (v.params.watchSlidesProgress = !0, v.classNames.push("swiper-container-3d")) :
                ...
                for (e = 0; e < v.slides.length; e++) {
                    ...
                    if (v.params.slidesPerColumn > 1) {
                        ...
                        "column" === v.params.slidesPerColumnFill ? (f = Math.floor(e / p), h = e - f * p, (f > u || f === u && h === p - 1) && ++h >= p && (h = 0, f++), m = f + h * o / p, c.css({
                            ...
                            "-moz-box-ordinal-group": m, "-ms-flex-order": m, "-webkit-order": m, order: m
                ...
                0 === v.snapGrid.length && (v.snapGrid = [0]), 0 !== v.params.spaceBetween && v.slides.css(r() ? v.rtl ? {marginLeft: a + "px"} : {marginRight: a + "px"} : {marginBottom: a + "px"}), v.params.watchSlidesProgress &&
            ...
            window.navigator.msPointerEnabled) && ("container" === v.params.touchEventsTarget ? v.container : v.wrapper).addClass("swiper-wp8-" + v.params.direction), v.initEvents = function (e) {
                ...
                if (v.clickedSlide = t, v.clickedIndex = a(t).index(), v.params.slideToClickedSlide && void 0 !== v.clickedIndex && v.clickedIndex !== v.activeIndex) {
                    ...
                    if (v.params.loop)if (i = a(v.clickedSlide).attr("data-swiper-slide-index"), n > v.slides.length - v.params.slidesPerView)v.fixLoop(), n =
            ...
            if (v.onTouchStart = function (e) {
                    ...
                    if (e.originalEvent && (e = e.originalEvent), v.emit("onTouchEnd", v, e), y) {
                        ...
                        if (r = v.params.followFinger ? v.rtl ? v.translate : -v.translate : -S, v.params.freeMode) {
                            ...
                            if (v.params.freeModeMomentum) {
                                ...
                                if (u < v.maxTranslate())v.params.freeModeMomentumBounce ? (u + v.maxTranslate() < -f && (u = v.maxTranslate() - f), c = v.maxTranslate(), m = !0, z = !0) : u = v.maxTranslate(); else if (u > v.minTranslate())v.params.freeModeMomentumBounce ? (u - v.minTranslate() >
                                f && (u = v.minTranslate() + f), c = v.minTranslate(), m = !0, z = !0) : u = v.minTranslate(); else if (v.params.freeModeSticky) {
                                    var h, g = 0;
                    ...
                    if (v.params.loop && v.destroyLoop(), "object" == typeof e && e.length)for (var a =
                        0; a < e.length; a++)e[a] && v.wrapper.append(e[a]); else v.wrapper.append(e);
                    ...
                    fade: {
                        ...
                        setTranslate: function () {
                            ...
                            if (v.wrapper.css({
                                ...
                                var h = Math.abs(t) - 90 * Math.floor(Math.abs(t) / 90), g = 1.5 - (Math.sin(2 * h * Math.PI / 360) / 2 + Math.cos(2 * h * Math.PI / 360) / 2), w = v.params.cube.shadowScale, y = v.params.cube.shadowScale /
                                    g, x = v.params.cube.shadowOffset;
                        ...
                        if (v.params.hashnav) {
                            ...
                            if (e)for (var a = 0, t = 0, s = v.slides.length; s > t; t++) {
                                ...
                                if (i === e && !r.hasClass(v.params.slideDuplicateClass)) {
                                    var n = r.index();
                                    v.slideTo(n, a, v.params.runCallbacksOnInit,
                                        !0)
                                }
                            }
                        }
            ...
            return v.callPlugins = function (e) {
                ...
                var a;
                if (v.emitterEventListeners[e])for (a = 0; a < v.emitterEventListeners[e].length; a++)v.emitterEventListeners[e][a](arguments[1], arguments[2], arguments[3], arguments[4],
                    arguments[5]);
    ...
    t.prototype = {
        ...
        device: function () {
            var e = navigator.userAgent,
                a = e.match(/(Android);?[\s\/]+([\d.]+)?/), t = e.match(/(iPad).*OS\s([\d_]+)/), s = e.match(/(iPod)(.*OS\s([\d_]+))?/), r = !t && e.match(/(iPhone\sOS)\s([\d_]+)/);
...
(function () {
    ...
    b = function () {
        ...
        return e.prototype.defaults = {
            ...
            return b && this.cacheAnimationName(a), a.style.visibility = b ? "hidden" : "visible", c && this.vendorSet(a.style, {animationDuration: c}), d && this.vendorSet(a.style,
                {animationDelay: d}), e && this.vendorSet(a.style, {animationIterationCount: e}), this.vendorSet(a.style, {animationName: b ? "none" : this.cachedAnimationName(a)}), a
